# Variational Encoder Forecasting Model

Variational Encoder Model implemented in TensorFlow+Keras for the Forecasting problem category as per Ready Tensor specifications.
...
- A **Variational Encoding Forecaster** algorithm built using **Darts**
